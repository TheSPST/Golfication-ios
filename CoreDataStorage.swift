...
//  SpacePhoto
//
//  Created by Rishabh Sood on 23/02/19.
...
//    }
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "CoreDataDistanceModel", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.sharingGolfShots")!
        let url = directory.appendingPathComponent("CoreDataDistanceModel.sqlite")
        do {
...
extension NSManagedObject {
    ...
    /*public class func createActivity(context: NSManagedObjectContext, entityName: String, finalArray:[[(latitude: Double, longitude:Double)]]) -> NSManagedObject {
        
        let newActivity = NSEntityDescription.insertNewObject(forEntityName: entityName, into: context)
//        newActivity.latitude = latitude
//        newActivity.repeat = repeatVal
//        newActivity.rest = restVal
//        newActivity.set = setVal
