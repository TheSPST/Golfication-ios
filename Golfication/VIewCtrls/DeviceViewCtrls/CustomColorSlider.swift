...
//
//https://github.com/nickypatson/GradientSlider
import UIKit
...
public class CustomColorSlider: UIControl {
    ...
    static let colorArray : [Any] = [UIColor(red: 234/255, green: 106/255,   blue: 127/255, alpha: 1.0).cgColor,
                                     UIColor(red: 74/255, green: 187/255, blue: 150/255, alpha: 1.0).cgColor,
                                     UIColor(red: 234/255, green: 106/255,   blue: 127/255, alpha: 1.0).cgColor]
...
//        track.cornerRadius = defaultHeight / 2.0
    ...
    fileprivate var _thumbLayer:UIImageView = {
        let thumb = UIImageView()
        thumb.image = #imageLiteral(resourceName: "swing_progress")
...
//        self.layer.addSublayer(_thumbLayer)
    ...
    override public func layoutSublayers(of layer: CALayer) {
        ...
        _thumbLayer.frame = CGRect(x: 0, y: 15, width: 10, height: 10)
...
//        _thumbLayer.position = CGPoint(x: left + (trackWidth * perc), y: halfHeight)
        _thumbLayer.frame.origin.x = left + (trackWidth * perc) - 7
    }
...
//        let center = _thumbLayer.position
        let center = CGPoint(x: _thumbLayer.frame.origin.x, y: _thumbLayer.frame.origin.y)
