...
@synthesize radialDistance, inclination, azimuth, baseDistance;
...
- (void)calibrateUsingOrigin:(CLLocation *)origin useAltitude:(BOOL) useAltitude {
    ...
    self.baseDistance = [origin distanceFromLocation:self.geoLocation];
//    NSLog(@"distance: %f",self.baseDistance);
